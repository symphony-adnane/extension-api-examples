  ...
  function (data) {
    ...
    SYMPHONY.application
      .register(
        ...
        ['hello:controller', 'message:controller']
      )
      .then(
        function (response) {
          ...
          uiService.registerExtension('single-user-im', 'hello-im', 'hello:controller', {
            label: 'IM Button',
            data: { datetime: Date() },
          });
          uiService.registerExtension('multi-user-im', 'hello-mim', 'hello:controller', {
            label: 'MIM Button',
          });
          uiService.registerExtension('room', 'hello-room', 'hello:controller', {
            label: 'Room Button',
          });
          uiService.registerExtension('profile', 'hello-profile', 'hello:controller', {
            label: 'Profile Button',
          });
          uiService.registerExtension('hashtag', 'hello-hashtag', 'hello:controller', {
            label: 'Hashtag Link',
          });
          uiService.registerExtension('cashtag', 'hello-cashtag', 'hello:controller', {
            label: 'Cashtag Link',
          });
          uiService.registerExtension('settings', 'hello-settings', 'hello:controller', {
            label: 'Settings Link',
          });
          ...
          helloControllerService.implement({
            ...
            select: function (id) {
              ...
              if(id==='hello-nav-remove'){
                navService.remove(id);
                alert('Item has been removed.')
              }
              if(id==='hello-nav-count'){
                navService.count(id,++NAV_COUNTER);
              }
            },
            ...
            trigger: function (uiClass, id, payload, data) {
              if (uiClass == 'single-user-im') {
                ...
                modulesService.show(
                  'hello-cashtag:' + cashtag,
                  { title: moduleTitle },
                  'hello:controller',
                  'https://localhost:4000/app.html?cashtag=' + cashtag,
                  {
                    canFloat: true,
                    // Use parentModuleId to open a new module without closing the original module ("hello")
                    parentModuleId: 'hello',
                ...
                modulesService.focus('hello-cashtag:' + cashtag);
            ...
            link: function (type, articleId) {
              if (type == 'article') {
                ...
                modulesService.show(
                  ...
                  { title: moduleTitle },
                  'hello:controller',
                  'https://localhost:4000/app.html?article=' + articleId,
                  {
                    canFloat: true,
                    // Use parentModuleId to open a new module without closing the original module ("hello")
                    parentModuleId: 'hello',
          ...
          messageControllerService.implement({
            ...
            pause: function (){
                console.info('PAAAAAUSING');
            },

            resume: function (){
                console.info('RESUUUUMING');
            },
            ...
            render: function (type, entityData) {
              ...
              if (version == '1.0') {
                ...
                const res = this.getTimeData(entityData);
                return res;
              }
            },
            ...
            getTimeData: function (entityData) {
              ...
              if (entityData.version === '1.0') {
                ...
                template = `<messageML>
                                  <card>
                                      ...
                                      <span class=''><text id="years"/></span> years, 
                                      <span class=''><text id="hrs"/></span> days, 
                                      <span class=''><text id="min"/></span> minutes, and
              ...
              return {
                ...
                data: {
                  ...
                  sec: '' + diff.sec,
                  timeAtRender:
                    renderTime.toLocaleTimeString() + ' on  ' + renderTime.toLocaleDateString(),
                },
              };
            },
          });
